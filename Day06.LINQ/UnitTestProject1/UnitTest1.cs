...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void SortByNameAndAge()
        {
            ...
            actualDataSecondList = userListSecond.OrderBy(u => u.Age).ToList().OrderBy(u => u.Name).ToList();
        ...
        public void SelectsValuesByNameMax()
        {
            ...
            actualData = userListSecond.Where(u => u.Name.Equals("Max")).ToList();
        ...
        public void ContainOrNotContainName()
        {
            ...
            //name max 
            //ToDo Add code for second list
            isContain = (userListSecond.Find(u => u.Name.Equals("Max")) != null);
        ...
        public void AllListWithName()
        {
            ...
            //name max 
            //ToDo Add code for second list
            isAll = userListFirst.Select(u => u.Name).Contains("Max") &&
                    userListSecond.Select(u => u.Name).Contains("Max");
        ...
        public void ReturnsOnlyElementByNameMax()
        {
            ...
            try
            {
                //ToDo Add code for second list
                //name Max
                actualData = userListSecond.Single(u => u.Name.Equals("Max"));
        ...
        public void ReturnsOnlyElementByNameNotOnList()
        {
            ...
            try
            {
                //ToDo Add code for second list
                //name Ldfsdfsfd
                actualData = userListSecond.First(u => u.Name.Equals("Ldfsdfsfd"));
                Assert.Fail();
            }
            catch (InvalidOperationException ie)
            {
        ...
        public void ReturnsOnlyElementOrDefaultByNameNotOnList()
        {
            ...
            //name Ldfsdfsfd
            actualData = userListSecond.SingleOrDefault(u => u.Name.Equals("Ldfsdfsfd"));
        ...
        public void ReturnsTheFirstElementOrDefaultByNameNotOnList()
        {
            ...
            //ToDo Add code for second list
            //name Ldfsdfsfd
            actualData = userListSecond.FirstOrDefault(u => u.Name.Equals("Ldfsdfsfd"));
        ...
        public void GetMaxSalaryFromFirst()
        {
            ...
            actualData = userListFirst.OrderByDescending(u=>u.Salary).First();
        ...
        public void GetCountUserWithNameMaxFromSecond()
        {
            ...
            //ToDo Add code for second list
            actualData = userListSecond.FindAll(u => u.Name.Equals("Max")).Count;
        ...
        public void Join()
        {
            ...
            var actualDataCount = -1;

            //ToDo Add code for second list
            var actualData = userListSecond.Join(NameInfo, u => u.Name, i => i.name, (u,i)=> new {Age = u.Age, Gender = u.Gender, Name = u.Name,
                Salary = u.Salary, Info = i.Info}).ToList();
            actualDataCount = actualData.Count();
            //сравнить два массива (анонимный со всеми полями юзера+инфо) и с коллекцией mock-объектов, написанных вручную. сравнивать Collection.Assert
            var expectedData = new []
            {
                new {Age = 23, Gender = Gender.Man, Name = "Max", Salary = (decimal)24000, Info = "info about Max"},
                new {Age = 23, Gender = Gender.Man, Name = "Max", Salary = (decimal)24000, Info = "info about Max"},
                new {Age = 45, Gender = Gender.Man, Name = "Alex", Salary = (decimal)54000, Info = "About Alex"},
            }.ToList();
            Assert.IsTrue(expectedDataCount == actualDataCount);
